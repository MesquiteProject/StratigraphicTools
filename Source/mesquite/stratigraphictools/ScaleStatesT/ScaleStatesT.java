...
*/
package mesquite.stratigraphictools.ScaleStatesT;
/*~~  */
...
/* ======================================================================== */
public class ScaleStatesT extends NumberForTaxonIncr {
	MesquiteNumber num;
	...
	ScaleDistribution observedStates =null;
	...
	public boolean startJob(String arguments, Object condition, boolean hiredByName) {
 		characterSourceTask = (CharSourceCoordObed)hireCompatibleEmployee(CharSourceCoordObed.class, ScaleState.class, "Source of characters (for Scale States of Period)");
		...
		itemItem = addMenuItem("Item of Scale State...", itemChoiceCommand);
 		return true;
  	 }
	...
	/*.................................................................................................................*/
    	 public Object doCommand(String commandName, String arguments, CommandChecker checker) {
    	 	...
    	 	else if (checker.compare(this.getClass(), "Sets the item to use (in a multi-item Scale data matrix)", "[item number]", commandName, "setItem")) {
    	 		int ic = MesquiteInteger.fromString(arguments);
    	 		if (!MesquiteInteger.isCombinable(ic) && observedStates!=null){
				ic = observedStates.userQueryItem("Select item to use for Scale State of Period", this);
    	 		}
 			...
 			else if (observedStates !=null && observedStates instanceof ScaleDistribution) {
	...
	public void calculateNumber(Taxon taxon, MesquiteNumber result, MesquiteString resultString){
		...
		if (taxa != currentTaxa || currentChar != lastCharRetrieved || observedStates == null ) {
			...
			observedStates = (ScaleDistribution)characterSourceTask.getCharacter(taxa, currentChar);
			currentTaxa = taxa;
