...
public class ScaleAdjustable  extends ScaleDistribution implements AdjustableDistribution {
	protected DoubleArray firstItem; //other dimension for items (sample size, variance, etc., etc.)
	protected Vector items;
	protected int numNodes;
	
	public ScaleAdjustable (Taxa taxa, int numNodes) {
		super(taxa);
		items = new Vector();
	...
	public DoubleArray addItem(NameReference nr){
			...
			for (int it=0; it<numNodes; it++)
					item.setValue(it, ScaleState.unassigned);
	...
	/*.........................................ContinuousAdjustable...............*/
	public void setItems(ScaleAdjustable s){
		if (s==null)
	...
	public void deassignStates(){
		for (int i=0; i<getNumItems(); i++)
			for (int j=0; j<numNodes; j++)
				((DoubleArray)items.elementAt(i)).setValue(j, ScaleState.unassigned);
	}
	/*.........................................ContinuousAdjustable...............*/
	...
	public void setCharacterState (int N, CharacterState cs) {
		...
		if (cs == null || !(cs instanceof ScaleState))
			return; 
		for(int i=0; i<getNumItems(); i++)
			setState(N, i, ((ScaleState)cs).getValue(i));
	}
	/*..........................................  ContinuousAdjustable ..................................................*/
	...
	public AdjustableDistribution adjustSize(Taxa taxa) {
		if (taxa.getNumTaxa() == this.getNumTaxa())
			...
			ScaleAdjustable soc = new ScaleAdjustable(taxa, taxa.getNumTaxa());
			soc.setItemsAs(this);
