...
public class ScaleState extends CharacterState implements ItemContainer {
	...
	public ScaleState (double value) {
		numItems = MAXITEMS;
		values = new double[MAXITEMS];
		names = new NameReference[MAXITEMS];
		for (int i=0; i<MAXITEMS; i++) {
